...
// If at least one method is abstract, the class must be declared as abstract.
// An abstract class can have both abstract and non-abstract methods.

// abstract void myMethod(int x, int y); // Abstract Method
...
// When an abstract class is subclassed, the subclass must implement all
// abstract methods of the superclass. If it doesn't, then the subclass must
// also be declared as abstract.

// A class that implements interface must implement all interface's methods.
// If it doesn't, then the subclass must also be declared as abstract.

// Abstract class vs Interface - Multiple Inheritance
// Abstract class can declare fields that are not static and final.
// An abstract class can define access modifiers.
// Interfaces' fields are implicitly public, static, and final.

// Classes
// Final - The class cannot be inherited by other class.
// Static - The class can be accessed without creating an instance of the class.
// Abstract - The class cannot be instantiated, but can be subclassed.
